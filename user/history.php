...
// Base Query - Limit to completed history only
$where = ["c.user_id = ?", "c.status = 'Completed'"];
$params = [$user_id];
...
<style>
    ...
    .hist-hero-left h1 { font-size: 28px; font-weight: 800; margin-bottom: 10px; }
    .hist-hero-left p { opacity: 0.9; font-size: 14px; margin: 0; }
    .hist-hero-count { text-align: center; background: rgba(255,255,255,0.2); backdrop-filter: blur(10px); padding: 15px 25px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.3); }
    .hist-hero-count .num { font-size: 36px; font-weight: 900; line-height: 1; margin-bottom: 5px; }
    .hist-hero-count .lbl { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; }
...
<div class="history-container">
    ...
    <div class="head-title">
        <div class="left">
            <h1><?php echo __('user_history_title', 'History'); ?></h1>
        </div>
    ...
    <div class="hist-hero">
        <div class="hist-hero-left">
            <h1><?php echo __('user_history_completed_title', 'Completed History'); ?></h1>
            <p><?php echo __('user_history_completed_desc', 'Complaints that have been resolved and closed.'); ?></p>
        </div>
        <div class="hist-hero-count">
            <div class="num"><?php echo $total_count; ?></div>
            <div class="lbl"><?php echo __('user_stats_cases', 'Cases'); ?></div>
        </div>
    </div>
        ...
        <form method="GET" style="display:contents;">
            ...
            <div class="filter-pill datepicker-wrap">
                ...
                <input type="text"
                       ...
                       placeholder="<?php echo __('history_th_date', 'Date Reported'); ?>"
                       title="<?php echo __('history_th_date', 'Date Reported'); ?>">
            </div>

            <?php if($agency || $search || $submit_date): ?>
                <a href="history.php" class="reset-btn" title="<?php echo __('btn_reset', 'Reset'); ?>">
                    ...
                    <?php foreach ($complaints as $index => $complaint): ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="history_details.php?id=<?php echo $complaint['id']; ?>" style="color:var(--dark-grey);font-size:20px;" title="<?php echo __('details_view_details', 'View Details'); ?>">
            ...
            <?php foreach ($complaints as $index => $complaint): ?>
                ...
                <div class="m-complaint-card" style="border-left-color: <?php echo $border; ?>;">
                    ...
                    <div class="m-card-meta">
                        ...
                        <div class="m-meta-item">
                            <div class="m-meta-label"><?php echo __('history_th_date', 'Date Reported'); ?></div>
                            <div class="m-meta-value"><?php echo date('d/m/Y', strtotime($complaint['created_at'])); ?></div>
                        </div>
                    </div>
                    <div class="m-card-footer">
                        <a href="history_details.php?id=<?php echo $complaint['id']; ?>" class="m-view-btn">
